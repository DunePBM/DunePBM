...
if (empty($_POST)){
    ...
    if (!isset($game['setupRound'])) {
        ...
        $game['setupRound']['next'] = 'makePrediction';
    }

    //##############################################################
    //## Make Prediction ###########################################
    //##############################################################
    if ($game['setupRound'['next'] == 'makePrediction') {
...
//###### Forms #########################################################
//######################################################################
if ((!empty($_POST)) && (isset($game['setupRound']['next']))) {
...
function action_makePrediction() {
    global $game, $info;
    dune_readData();
    // Checks input.
